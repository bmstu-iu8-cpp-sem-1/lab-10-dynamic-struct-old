...
// Удаляет элемент из начало списка. Освобождает память удаленного элемента.
void PopFront(ForwardList& list);

// Удаляет элемент после элемента, на который указывает |node|. Освобождает память удаленного элемента.
...
// Удаляет элемент из очереди. Возвращает значение удаленного элемента. Освобождает память удаленного элемента.
int Pop(Queue& queue);
...
// Снимает элемент с верхушки стека. Возвращает значение удаленного элемента. Освобождает память удаленного элемента.
int Pop(Stack& stack);
